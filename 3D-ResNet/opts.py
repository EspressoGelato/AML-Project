...
def parse_opts():
    ...
    parser.add_argument('--video_pretrained_path',
                        default='pretrained/results-3/checkpoint_35000.pth',
                        type=Path,
                        help='Path to the pretrained weight on MSR-VTT')
      
    parser.add_argument('--linear_prob',
                        action='store_true',
                        help='if use pretrained weight with two layers of linear')
    
    parser.add_argument('--finetune_video',
                        action='store_true',
                        help='if finetue the weights')
