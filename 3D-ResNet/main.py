...
from models.LinearProb import ModelPlusLinearLayers
...
def main_worker(index, opt):
    ...
    if opt.inference:
        model = ModelPlusLinearLayers(opt, 512, 512)
    else:
        model = ModelPlusLinearLayers(opt, 512, 512)
    ...
    if opt.inference is False:
        ...
        #################################################################################
        (train_loader, train_sampler, train_logger, train_batch_logger, optimizer,  scheduler) = \
            get_train_utils(opt, model_parameters=parameters)
