...
from virtex.data.readers_video import SimpleVideoCaptionsReader
...
if __name__ == "__main__":
    ...
    dloader = DataLoader(
        SimpleVideoCaptionsReader(_A.data_root, _A.split),
    ...
    for idx, batch in enumerate(tqdm(dloader)):
        ...
        for instance in batch:
            ...
            length, width, height, channels = image.shape
