...
from virtex.modules.r21d import generate_model


class CaptioningVideoModel(nn.Module):
    r"""
...
class ForwardCaptioningModel(CaptioningVideoModel):
    r"""
...
class BidirectionalCaptioningModel(CaptioningVideoModel):
    r"""
    Convenient extension of :class:`~virtex.models.captioning.CaptioningModel`
...
VirTexModelVideo = BidirectionalCaptioningModel
