...
from virtex.modules import visual_backbones, textual_heads, r21d
...
class PretrainingDatasetFactory(Factory):
    ...
    PRODUCTS: Dict[str, Callable] = {
        ...
        "virtex_video": vdata.CaptioningDatasetVideo,
...
class VisualBackboneFactory(Factory):
    ...
    def from_config(cls, config: Config) -> visual_backbones.VisualBackbone:
        ...
        elif "r21d" in _C.MODEL.VISUAL.NAME:
            model_depth=18
            print("#"*50, "doing model")
            #assert model_depth == _C.R21D.model_depth
            kwargs = {}
            if model_depth == 18:
                kwargs['layer_sizes'] = (1, 1, 1, 1)
                kwargs['with_classifier'] = True
                kwargs['use_features'] = True
                #kwargs['return_conv'] = True

            return cls.create("r21d", **kwargs)
...
class TextualHeadFactory(Factory):
    ...
    def from_config(cls, config: Config) -> nn.Module:
        ...
        if "trans" in _C.MODEL.TEXTUAL.NAME:
            ...
            mask_future = _C.MODEL.NAME in {"virtex_video", "virtex", "captioning", "bicaptioning"}
...
class PretrainingModelFactory(Factory):
    ...
    PRODUCTS: Dict[str, Callable] = {
        ...
        "virtex_video":vmodels.VirTexModelVideo,
    ...
    def from_config(cls, config: Config) -> nn.Module:
        ...
        if _C.MODEL.NAME in {"virtex", "virtex_video", "captioning", "bicaptioning"}:
            kwargs = {
